...
창 목록·메뉴·닫기 수정 검증은 [v0.3.2 QA](docs/QA-v0.3.2.md)를 참고하세요. 이전 권한·애니메이션 수정과 측정 범위는 [v0.3.1 QA](docs/QA-v0.3.1.md)를 참고하세요. 코드와 docs는 [저장소 작업 지침](AGENTS.md)에 따라 같은 변경에서 갱신합니다.
