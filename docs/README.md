...
문서 기준: **v0.3.9 / 2026-09-11 / 공개 베타**. 문서는 현재 코드와 실제 확인 결과를 기준으로 작성하며, 목표를 달성한 실적으로 표현하지 않습니다.
...
코드와 문서는 [AGENTS.md](../AGENTS.md)의 정합 규칙을 따른다. 최신 수정·실행 근거는 [v0.3.9 QA](QA-v0.3.9.md)에 기록한다. 과거 버전 PASS는 새 버전 전체 검증을 뜻하지 않는다.
