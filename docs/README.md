...
문서 기준: **v0.3.0 / 2026-09-07 / 공개 베타**. 문서는 현재 코드와 실제 확인 결과를 기준으로 작성하며, 목표를 달성한 실적으로 표현하지 않습니다.
...
| MR-02 익숙한 조작·시각 반응 | P-02 | FR-03~FR-07 | TC-A05, A09, M06~M11 |
| MR-03 기본 Dock와 복원 | P-03 | FR-08, FR-09 | TC-A07, A10, M12~M15 |
| MR-04 일상 파일 작업 | P-04 | FR-10~FR-13 | TC-M16~M22 |
| MR-05 창을 보고 선택 | P-05 | FR-14, FR-15 | TC-M23~M27 |
...
현재 자동 테스트는 10개입니다. 그중 `DockLayout`을 호출하는 3개는 레거시 순수 좌표 함수 검증이며, 실제 `DockCoordinator`의 화면 배치를 검증하는 UI 테스트가 아닙니다. 기존 실기기 기록은 [QA.md](../QA.md)에 보존합니다. 성능 목표와 미허용 권한 경로는 별도 검증이 필요합니다.
