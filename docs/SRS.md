...
FR-24 v0.3.4 변경: v0.3.3의 같은 화면 제한은 사용자 보고에서 메뉴 사용 자체를 막았으므로 제거했다. 로컬 표시와 실제 명령 전달의 검증은 [QA-v0.3.4](QA-v0.3.4.md)에 구분해 기록한다.
