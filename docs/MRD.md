...
고정 앱을 사용자가 구분선으로 정리하고, 고정하지 않은 실행 앱은 고정 영역과 폴더 사이에 모아 보여준다. 구분선은 설정의 고정 앱 목록과 Dock에서 동일하게 이동·삭제한다. 폴더 반복 열기로 기존 썸네일이 사라지거나 이전 팝업의 취소가 새 팝업에 영향을 주지 않아야 한다. FR-25/FR-26과 TC-A40~42, TC-M53~55에 연결한다.
