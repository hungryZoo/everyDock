...
메뉴의 이동 명령을 반복하지 않고 Command-드래그로 고정 앱과 구분선을 원하는 위치에 배치한다. 고정하지 않은 실행 앱은 고정 영역에 놓아 고정할 수 있다. 잘못 놓거나 취소했을 때 앱 실행·최소화·고정 해제가 일어나지 않아야 한다. FR-27과 TC-A44~45, TC-M56~58에 연결한다.
