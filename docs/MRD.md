...
일반 삭제 후에도 설정·첫 실행 완료가 유지된다는 점을 안내하고, 완전히 새로운 안내 흐름을 시험할 때 선택할 수 있는 설정 초기화 제거를 제공한다. 사용 중인 앱의 업그레이드는 설정을 보존한다. macOS 권한과 로그인 항목은 앱 설정과 별도 수명으로 설명한다. FR-30, TC-R07에 연결한다.
