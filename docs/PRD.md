...
| P-04 | P1 | 일상 유틸리티 | 바탕화면·다운로드 목록·열기. Apps는 검색 가능한 설치 앱 목록. 휴지통 이동·취소 가능한 비우기 확인. 복사 덮어쓰기 없음 | 바탕화면 동작 변경; v0.3.3 QA에서 검증 범위 구분 |
...
- P-02/P-04: Apps 아이콘은 일반 앱 최소화/활성화 대신 everyDock의 앱 검색 팝업을 연다. 시스템 Apps/Spotlight UI의 완전 복제는 범위 밖이다.
